function theme_precmd {
  ...
  PR_FILLBAR=""
  PR_PWDLEN=""
  DATE_KR=$(date +"%Y년%m월%d일(%A)" | sed -E 's/Sunday/일요일/g; s/Monday/월/g; s/Tuesday/화/g; s/Wednesday/수/g; s/Thursday/목/g; s/Friday/금/g; s/Saturday/토/g')
...
${PR_YELLOW}${DATE_KR} %D{%H:%M:%S}${PR_BLUE}\
